...
local AccessorySettings = {
	...
	BlockArms	= false; -- Remove accessory meshes of this limb
	BlockLegs	= false; -- Remove accessory meshes of this limb
	BlockTorso	= false; -- Remove accessory meshes of this limb
