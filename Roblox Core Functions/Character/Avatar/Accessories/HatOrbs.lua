--Change to Block hats
--[[

mode 4 (default mode) moves in a circle around u (as soon as u execute is goes mode 4)

mode 1 (little circle thing) this 1 moves around u

mode 2 (little circle thing that doesnt move around u)

mode 3 (same as mode 1 just higher up)

mode 5 (makes them all in a huge line)

mode 6(same as mode 5 but it FLYS past u)

mode 7 (best in my opinion, does this weird motion around u)

mode 8( same as mode 5 but moves in a circle around u)

mode 9 (AUDIO VISUALIZOR) 
