...
--Use TrollAnimationBypass.lua

local model = game:GetService("Players").LocalPlayer.Character
local mouse = game:GetService("Players").LocalPlayer:GetMouse()
fakeguy = model
local Torso = model.Torso
local RS = fakeguy.Torso:FindFirstChild("Right Shoulder")
local LS = fakeguy.Torso:FindFirstChild("Left Shoulder")
local RH = fakeguy.Torso:FindFirstChild("Right Hip")
local LH = fakeguy.Torso:FindFirstChild("Left Hip")
local Neck = fakeguy.Torso:FindFirstChild("Neck")
local Torso = model.Torso
...
local Anim="Idle"
local RJ = fakeguy.HumanoidRootPart:FindFirstChild("RootJoint")
local cn = CFrame.new
local cf = CFrame.new
